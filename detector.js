function sendMail(majorAttack, attack, inputType) {
...
window.onload = function urlDetect(){
    ...
    // Check for a web attack in the URL
        if (link.indexOf("'") >= 0) { // SQL

            majorAttack = "SQL Injection";
            attack = "Error Based SQL Injection (')";
            inputType = "URL";

            sendMail(majorAttack, attack, inputType);

        } else if (link.indexOf("&&") >= 0) { // SQL

            majorAttack = "SQL Injection";
            attack = "Encoded Boolean Based SQL Injection (and and)";
            inputType = "URL";

            sendMail(majorAttack, attack, inputType);

        } else if (link.indexOf("%7C%7C") >= 0) { // SQL
        ...
        } else if (link.indexOf("%3Cscript") >= 0) { // XSS
        ...
        } else if (link.indexOf("%3Cimg") >= 0) { // XSS
...
function fieldsDetect() {
    ...
    // Fill variable with values of all inputfields via a loop
        ...
        // Check for a web attack
            ...
            } else if (gegeven.indexOf("<script") >= 0) { // XSS
            ...
            } else if (gegeven.indexOf("<img") >= 0) { // XSS
